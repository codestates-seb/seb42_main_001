...
INSERT INTO section(section_content, section_TITLE, article_ID) VALUES ('
 ...
 영국 해군들이 보급 받은 럼에 불이 붙는 것을 통해 도수가 높고 자칫 넘친 럼주가 화약을 적셔도\n사용할 수 있는 것을 증명(prove)했다는 데서 술의 도수를 나타내는 proof가 유래했다는 설을 알고 계신가요?
...
보통 위스키에 증류된 연도가 적혀있지 않지만 한정판 혹은 싱글캐스크등 특별한 경우에 증류 연도를 적어놓는 경우가 있습니다.\n자녀 혹은 소중한 사람에게 그 사람이 태어난 해에 증류된 위스키를 선물해보는 것은 어떨까요?
...
이는 오래전 얼음이 보편화되지 않았던 시절, 스코틀랜드인들이 위스키를 차갑게 마시기 위해, \n계곡의 차가운 돌맹이를 주워 쓰기 시작한데서 왔다고 합니다. 차가운 돌멩이가 든 잔에 위스키를 부어 마실 때 돌맹이가 얼음의 역할을 했던 것이라 할 수 있습니다.
...
INSERT INTO section(section_content, section_TITLE, article_ID) VALUES ('
 ...
 미즈와리
	...
	대부분의 일본인들은 일본인이 서양인에 비해 알콜 분해능력이 낮아 술을 오래 즐길 수 없는 데서 비롯되었다는 내용으로 알고 있으나, \n일본 주류 업계에서는 제조사들의 프로모션을 통해 널리 퍼진 것으로 볼 수 있음
