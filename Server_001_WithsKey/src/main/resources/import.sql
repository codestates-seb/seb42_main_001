...
INSERT INTO DRINK(DRINK_ID, DRINK_ABV, DRINK_CODE, DRINK_IMAGE_URL, DRINK_NAME, PRICE_RANK) VALUES (1,10,'DRINK코드','IMAGE_URL','DRINK_NAME', 'LV1');
INSERT INTO DRINK(DRINK_ID, DRINK_ABV, DRINK_CODE, DRINK_IMAGE_URL, DRINK_NAME, PRICE_RANK) VALUES (2, 40, 'WYK', 'sampleurl', '싱글 몰트 위스키', 'Entry_Level');


INSERT INTO ARTICLE(TITLE) VALUES ('위스키를 아시나요?');
INSERT INTO SECTION(SECTION_CONTENT, SECTION_TITLE, ARTICLE_ID)
VALUES ('여러분은 바에 가보신 적 있어요? :wine_glass:어땠어요?
...
INSERT INTO TAG_BOARD(TAG_BOARD_ID, BOARD_ID, TAG_ID) VALUES (1, 100, 1);
INSERT INTO TAG_BOARD(TAG_BOARD_ID, BOARD_ID, TAG_ID) VALUES (2, 101, 1);
INSERT INTO TAG_BOARD(TAG_BOARD_ID, BOARD_ID, TAG_ID) VALUES (3, 102, 2);

INSERT INTO TAG_DRINK(TAG_DRINK_ID, DRINK_ID, TAG_ID) VALUES (1, 101, 1);
INSERT INTO TAG_DRINK(TAG_DRINK_ID, DRINK_ID, TAG_ID) VALUES (2, 102, 2);

INSERT INTO TASTING_NOTE(TASTING_NOTE_ID,SWEET, SMOKY, CITRUS, HERBAL, TROPICAL,DRINK_ID) VALUES (1,5,4,4,4,1,101);